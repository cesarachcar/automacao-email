...
def enviar_email(indice, nome, email):
    ...
    #anexar arquivos
    caminho_anexo = r'C:\Users\Desktop\Codigos\Integracao_e-mail\anexos'
...
df_email_clientes = pd.read_excel(r'C:\Users\Codigos\Integracao_e-mail\email_clientes.xlsx')
